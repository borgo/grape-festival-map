    ...
    async function onReady() {
        ...
        try {
            ...
            if (window.location.pathname.includes("/en/")) { 
              ...
              addAnnotation("Royal crown zone", "royal_crown_zona_1");
              ...
              addAnnotation("Main entrance", "main_entry_2");
              addAnnotation("Entrance for tent city", "entry_tent_city");
              addAnnotation("White night \"Perspektíva\"", "biela_noc_perspektiva");            
              addAnnotation("Chill village", "chill_village");
              addAnnotation("Tent Inn", "tent_inn");
              addAnnotation("U rampa", "u_rampa");            
              addAnnotation("Tents", "tents");
              addAnnotation("First aid", "doctor_3");
            } else {
